...

        {
...

            {
...

                {
                    ...
                    File file = new File(Environment.getExternalStorageDirectory(),"Image_picker/img"+ String.valueOf(System.currentTimeMillis())+".jpg");
...
dialog.show();
        ...
        SetImageView = (ImageView) findViewById(R.id.img_set1);


        Button tmb_pilih1 = (Button) findViewById(R.id.btn_pilih1);

        tmb_pilih1.setOnClickListener(new View.OnClickListener() {
